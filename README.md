...
* **Estilização:** Tailwind CSS (via CDN no `base.html`)
* **Interatividade:** Alpine.js
* **Configuração:** Python-Decouple (para variáveis de ambiente)
* **Segurança:** PBKDF2 (Hashing de senhas integrado ao Model)
...
```bash
# Clone o repositório
git clone https://github.com/LaisOliveiira/projeto_web_gebov
